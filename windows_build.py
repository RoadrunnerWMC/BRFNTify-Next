...
# windows_build.py
# Builds BRFNTify to a Windows binary (*.exe)
# Use the values below to configure the release:

PackageName = 'BRFNTifyNext_B1_win32'
Version = '0.1' # This must be a valid float in string format
...
if upxFlag:
    if os.path.isfile('upx/upx.exe'):
        ...
        print('>> In order to build BRFNTify with UPX, place the upx.exe file into '
...
print('>> BRFNTify has been frozen to %s !' % dir_)
